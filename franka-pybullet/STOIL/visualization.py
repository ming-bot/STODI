...
def Draw_multi_trajectories(init_traj, trajectory_list, demonstration):
    ...
    labels = ['Trajectory generated by STOMP (Bad)', 'Trajectory generated by STOMP (Good)', 'Trajectory generated by GSTOID']
    # labels = ['DTW', 'MSE in spectrum', 'MSE in power spectrum']
    ...
    ax.set_ylim((-0.2, 0.6))
    ax.set_zlim((0.5, 1.3))
    ax.legend(loc='center right', bbox_to_anchor=(0.0, 0.5))

    plt.show()

def Draw_multi_cost(cost_list):
    colors = ['#00A1CB', '#FABE28', '#FF5E5E', '#2B3E51', '#8A2BE2', '#FFC300', '#76D7EA']
    labels = ['STOMP Optimization (Bad)', "STOMP Optimization (Good)", 'GSTOID Optimization']
    # labels = ['DTW', 'MSE in spectrum', 'MSE in power spectrum']
