import numpy as np
from contour_cost import cal_dtw_similarity, calculate_kl_contour_cost, calculate_mse_contour_cost, calculate_nmse_contour_cost, calculate_js_contour_cost, cal_mse_euclidean_similarity
import copy
